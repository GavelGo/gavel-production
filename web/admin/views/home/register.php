                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" type="text" placeholder="Name" id="inputEmail">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox">On behalf of my organization, I agree to the <strong><em>Terms &amp; Conditions</em></strong> of service.</label>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-10 col-lg-offset-2" id="aga02">
                                        <button class="btn btn-primary" type="submit" style="margin:0px;">Submit</button>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
