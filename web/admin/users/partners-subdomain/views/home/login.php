                        ...
                        <form class="form-horizontal" action="" method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="email" id="email" class="form-control" type="text" placeholder="Email" id="inputEmail">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword" class="col-lg-2 control-label">Password</label>
                                    <div class="col-lg-10">
                                        <input name="password" id="password" class="form-control" type="password" placeholder="Password" id="inputPassword">
                                        <div class="checkbox">
